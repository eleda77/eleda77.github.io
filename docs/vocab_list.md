...
**Current Favourite Word:** maltster

**Runner-Up:** embiggen

**Most Fun to Say Aloud:** clayey
...
**abecedarian** - arranged alphabetically; rudimentary; a person who is just learning, a novice

**abecedarium** - alphabet book, primer
...
**acey-deucy** - a form of backgammon in which a player, upon rolling a 1–2, moves 3 and then is allowed to name and play any doublet and to roll again; (slang) A-ok, great
...
**aerogram** - a sheet of light paper folded and sealed to form a letter for sending by airmail

**affiance** - be engaged to marry

**affluenza** - a psychological malaise supposedly affecting wealthy young people, symptoms of which include a lack of motivation, feelings of guilt, and a sense of isolation (portmanteau of affluence and influenza)
...
**alack** - an expression of regret or dismay
...
**analemma** - the asymmetrical figure-eight curve that can be traced in the sky at a given place showing the position of the sun at the same standard time (usually twelve o'clock) on successive days of a year
...
**anode** - the negatively charged electrode of a device supplying current such as a primary cell

**anodyne** - not likely to provoke dissent or offense; inoffensive, often deliberately so

**anorak** - a studious or obsessive person with unfashionable and largely solitary interests; nerd
...
**apical** - relating to or denoting an apex; (phonetics) of a consonant, formed with the tip of the tongue
...
**appellation** - the action of giving a name to a person or thing
...
**aquamanile** - a water container or ewer, typically in the form of a mammal or bird, used in medieval times

**arborization** - a branching, treelike structure, as of the dendrites of a neuron

**archaism** - a thing that is very old or old-fashioned;  an archaic word or style of language or art; the use or conscious imitation of very old or old-fashioned styles or features in language or art
...
**ascot** - a man's broad silk necktie
...
**asterism** - a prominent pattern or group of stars, typically having a popular name but smaller than a constellation; a group of three asterisks (⁂) drawing attention to following text
...
**astrobug** - a bug that was sent to space to test the effects of space on a living creature
...
**aumbry** - a small recess or cupboard in the wall of a church
...
**autopia** - an urban landscape designed for use by the automobile
...
### B {#header-title-2}
**Briticism** - an idiom used in Britain but not in other English-speaking countries
...
**banjoed** - (also banjo'd) completely drunk, or under the influence
...
**bathyscaphe** - a manned submersible vessel of a kind used by the Swiss deep-sea explorer Auguste Piccard

**batman** - (in the British armed forces) an officer's personal servant
...
**bentwood** - wood that is artificially shaped for use in making furniture

**besom** - a broom made of twigs tied around a stick

**bespeak** - (of an appearance or action) suggest; be evidence of
...
**boatel** - a waterside hotel with facilities for mooring boats; a ship moored at a wharf and used as a hotel

**boffin** - a person engaged in scientific or technical research;  person with knowledge or a skill considered to be complex, arcane, and difficult

**bogosity** - the quality of being bogus
...
**bombard** - a cannon of the earliest type, which originally fired a stone ball

**bombogenesis** - a phenomenon or process in which there is rapid and sustained falling of barometric pressure in the center of a low-pressure system, indicative of its strengthening into a powerful storm
...
**bromidic** - attempting to soothe or placate in a trite or clichéd way; lacking in originality

**bruckle** - easily broken or crumbled

**brugh** - a town or borough
...
**calash** - a light low-wheeled carriage with a removable folding hood; a woman's hooped silk hood
...
**canalize** - convert (a river) into a navigable canal; convey (something) through a duct or channel
...
**caroche** - a luxurious horse-drawn carriage
...
**chapbook** - a small pamphlet containing tales, ballads, or tracts, sold by peddlers; a small paperback booklet, typically containing poems or fiction
...
**chatoyant** - (of a gem, especially when cut en cabochon) showing a band of bright reflected light caused by aligned inclusions in the stone; having a changing, shimmering luster
...
**chicane** - an artificial narrowing or turn on a road or auto-racing course; (in card games) a hand without cards of one particular suit; a void; chicanery
...
**claggy** - tending to form clots; sticky; (of weather) damp and overcast or misty
...
**cledgy** - clayey; stiff, tenacious, sticky
...
**copperas** - green crystals of hydrated ferrous sulfate, especially as an industrial product
...
**cordwainer** - a shoemaker (still used in the names of guilds)
...
**cornopean** - an early name for the cornet (instrument)
...
**cosmatesque** - a style of geometric decorative inlay stonework typical of the architecture of Medieval Italy, and especially of Rome and its surroundings
...
**coulee** - a deep ravine; a lava flow
...
**cyclotron** - a particle accelerator that uses magnetic and electric fields to speed up charged particles to very high speeds
...
**dalmatic** - a wide-sleeved, long, loose vestment open at the sides, worn by deacons and bishops, and by some monarchs at their coronation
...
**deduplicate** - eliminate duplicate or redundant information from (something, especially computer data)

**defalcate** - embezzle (funds with which one has been entrusted)

**defatigable** - able to be fatigued
...
**desquamate** - (of a layer of cells, e.g. of the skin) come off in scales or flakes
...
**dexter** - of, on, or toward the right-hand side (in a coat of arms, from the bearer's point of view, i.e., the left as it is depicted)
...
**dimidiation** - the combination of two coats of arms by juxtaposing the dexter half of one and the sinister half of the other on a single shield (a practice largely superseded by impalement)
...
**duff** - of very poor quality; incorrect or false
...
**embattle** - set (an army) in battle array; fortify (a building or place) against attack
...
**encrust** - cover (something) with a hard surface layer[C

**endling** - the last known individual of a species or subspecies

**endonym** - a name for a place or group of people that is used internally in that place, or by that people as a self-designation
...
**engrailed** - having semicircular indentations along the edge
...
**eructate** - emit stomach gas noisily through the mouth; belch
...
**esemplastic** - molding into one; unifying
...
**exogamous** - the custom of marrying outside a community, clan, or tribe
...
**fascine** - a rough bundle of brushwood or other material used for strengthening an earthen structure, or making a path across uneven or wet terrain

**fatling** - a young animal that has been fattened in readiness for slaughter
...
**fewterer** - a keeper of dogs (as greyhounds)
...
**firkytoodle** - to cuddle or fondle amorously
...
**fizzog** - a person's face or expression
...
**found** - to melt (a material, such as metal) and pour into a mold
...
**furuncle** - technical term for a boil (on the skin)
...
**galero** - the flat-crowned wide-brimmed tasseled red hat formerly worn by Roman Catholic cardinals
...
**glissade** - a way of sliding down a steep slope of snow or ice, typically on the feet with the support of an ice axe
...
**gongfermor** - someone who digs out and removes human excrement from privies and cesspits

**gorget** - an article of clothing that covered the throat; a patch of color on the throat of a bird or other animal, especially a hummingbird
...
**groat** - any of various medieval European coins, in particular an English silver coin worth four old pence, issued between 1351 and 1662; a small sum
...
**groundling** - a spectator who stood in the pit of an Elizabethan theater; a person of unsophisticated taste; one that lives or works on or near the ground
...
**guimpe** - a blouse worn under a jumper or pinafore; a wide cloth used by some nuns to cover the neck and shoulders
...
**hanap** - a large drinking-goblet, made of precious material such as gold or silver

**harrow** - cause distress to; draw a harrow over (land)
...
**holonym** - a  term that denotes the whole of which another term's referent is a part

**hornlet** - a small horn

**hornswoggle** - get the better of (someone) by cheating or deception

**hough** - to clear the throat; hack
...
**hypocoristic** - of the nature of a pet name or diminutive form of a name
...
**infodemic** - an excessive amount of information about a problem that is typically unreliable, spreads rapidly, and makes a solution more difficult to achieve (hmm, sounds familiar)
...
**interoception** - perception or awareness of the inner state of the body
...
**inurn** - place or bury (something, especially ashes after cremation) in an urn
...
**knapp** - shape (a piece of stone, typically flint) by striking it so as to make stone tools or weapons or to give a flat-faced stone for building walls; strike with a hard short sound; knock
...
**ladder** - a long, vertical hole in a pair of pantyhose or a stocking (a run)
...
**lapidary** - relating to stone and gems and the work involved in engraving, cutting, or polishing; (of language) engraved on or suitable for engraving on stone and therefore elegant and concise

**larrup** - thrash or beat (a person or animal); strike or hit (a ball) powerfully
...
**latinate** - (of language) having the character of Latin
...
**legation** - a diplomatic minister, especially one below the rank of ambassador, and their staff; he position or office of legate; a legateship
...
**louver** - a domed structure on a roof, with side openings for ventilation
...
**macerate** - (especially with reference to food) soften or become softened by soaking in a liquid; cause to grow thinner or waste away, especially by fasting
...
**madcap** - amusingly eccentric; done without considering the consequences; foolish or reckless
...
**meerschaum** - a soft white claylike material consisting of hydrated magnesium silicate; a tobacco pipe with a bowl made from meerschaum
...
**mickle** - a large amount; very large
...
**miniver** - plain white fur used for lining or trimming clothes
...
**miter** - a tall headdress worn by bishops and senior abbots as a symbol of office, tapering to a point at front and back with a deep cleft between

**mogadored** - confused or perplexed

**moggy** - a cat, especially one that does not have a pedigree

**moiety** - each of two parts into which a thing is or can be divided; a part or portion, especially a lesser share
...
**mugwump** - a person who likes to be politically independent and does not support or remain loyal to any political group; a stupid person
...
**mummer** - an actor in a traditional masked mime, especially of a type associated with Christmas and popular in England in the 18th and early 19th centuries; an actor in the theatre
...
**nidicolous** - (of a young bird or other animal) staying in the nest for a long time after birth
...
**nixie** - (in folklore) a water sprite (also nix)
...
**nonage** - a period of youth; lack of maturity
...
**nucleate** - form around a central area
...
**numismatic** - relating to or consisting of coins, paper currency, and medals
...
**ordure** - excrement; dung; something regarded as vile or abhorrent
...
**parasomnia** - any of a group of sleep disorders characterized by the regular occurrence of unusual movements, vocalizations, or experiences, such as sleepwalking, talking in one's sleep, or night terrors
...
**passant** - (of an animal) represented as walking, with the right front foot raised
...
**peccary** - a gregarious piglike mammal that is found from the southwestern US to Paraguay

**pedant** - a person who is excessively concerned with minor details and rules or with displaying academic learning

**pedantry** - excessive concern with minor details and rules

**pedicle** - a small stalklike structure connecting an organ or other part to the human or animal body
...
**penult** - the penultimate syllable of a word
...
**perlocution** - an act of speaking or writing which has an action as its aim but which in itself does not effect or constitute the action, for example persuading or convincing
...
**perplexity** - inability to deal with or understand something complicated or unaccountable; an entangled state
...
**pharaonic** - relating to or characteristic of a pharaoh or the time of the pharaohs
...
**plat** - a plot of land;  a map or plan of an area of land showing actual or proposed features
...
**plugumentary** - a film or television programme which purports to be a disinterested factual documentary, but contains publicity material

**plump (for)** - to express support for (someone or something)

**pluvial** - relating to or characterized by rainfall; a period marked by increased rainfal
...
**propitiation** - the action of propitiating or appeasing a god, spirit, or person; atonement, especially that of Jesus Christ
...
**proslambanomenos** - the lowest note in Ancient Greek music, appended to the bottom of the scale
...
**purgative** - strongly laxative in effect; having the effect of ridding someone of unwanted feelings or memories
...
**pyrolyze** - make or become decomposed through heating to a high temperature
...
**ragchew** - an extended, informal conversation (amateur radio)

**raillery** - good-humored teasing

**rampant** - (of an animal) represented standing on one hind foot with its forefeet in the air
...
**redingote** - a woman's long coat with a cutaway or contrasting front; a man's double-breasted topcoat with a full skirt

**regnal** - of a reign or monarch

**regolith** - the layer of unconsolidated rocky material covering bedrock

**regrate** - to buy up (necessities of life) at a market or fair with the intention of reselling in or near the same place at a profit

**relict** - a thing which has survived from an earlier period or in a primitive form; an animal or plant that has survived while others of its group have become extinct; a species or community that formerly had a wider distribution but now survives in only a few localities such as refugia; a widow
...
**rhetor** - a teacher of rhetoric; an orator

**rhotic** - relating to or denoting a dialect or variety of English (e.g. in most of the US and southwestern England) in which r is pronounced before a consonant (as in hard) and at the ends of words (as in far)
...
**ruderal** - o(of a plant) growing on waste ground or among refuse
...
**rusticate** - go to, live in, or spend time in the country; suspend (a student) from a university as a punishment (used especially at Oxford and Cambridge); fashion (masonry) in large blocks with sunk joints and a roughened surface
...
**scarp** - a very steep bank or slope; an escarpment; the inner wall of a ditch in a fortification
...
**screed** - a long speech or piece of writing, typically one regarded as tedious; a leveled layer of material (e.g., cement) applied to a floor or other surface
...
**scrumple** - to crumple, crush or wad (like a piece of paper)
...
**scull** - to propel (a boat) by sculls or by a large oar worked thwartwise
...
**scurrility** - the quality of being vulgar, coarse, or abusive
...
**shandy** - beer mixed with a nonalcoholic drink (typically lemonade)
...
**shofar** - a ram's-horn trumpet used by ancient Jews in religious ceremonies and as a battle signal
...
**sibship** - a group of offspring having the same two parents

**sidereal** - of or with respect to the distant stars (i.e. the constellations or fixed stars, not the sun or planets)

**sigillography** - the study of seals used to authenticate archival documents

**sinopia** - a dark reddish-brown natural earth pigment, widely used in Classical Antiquity and the Middle Ages for painting, and during the Renaissance it was often used on the rough initial layer of plaster for the underdrawing for a fresco
...
**spondulicks** - fractional currency; money, funds

**spoonula** - a cooking utensil resembling both a spoon and a spatula
...
**swingletree** - a crossbar pivoted in the middle, to which the traces are attached in a horse-drawn wagon or plow
...
**syllabub** - a whipped cream dessert, typically flavored with white wine or sherry
...
**tabular** - (of data) consisting of or presented in columns or tables; broad and flat like the top of a table
...
**tare** - the weight of a container or wrapper that is deducted from the gross weight to obtain net weight
...
**tetrarch** - (in the Roman Empire) the governor of one of four divisions of a country or province; one of four joint rulers
...
**thingummy** - something unspecified whose name is either forgotten or not known

**thole** - a pin, typically one of a pair, fitted to the gunwale of a rowboat to act as the fulcrum for an oar

**thoughtography** - the claimed ability to "burn" images from one's mind onto surfaces such as photographic film by parapsychic means

**thralldom** - the state of being in someone's power
...
**tipple** - drink alcohol, especially habitually; an alcoholic drink

**tisane** - a herbal tea; a medicinal drink or infusion, originally one made with barley

**titivate** - make small enhancing alterations to (something); (titivate oneself) make oneself look attractive
...
**tressure** - an ornamental enclosure containing a figure or distinctive device, formerly found on various gold and silver coins

**trews** - men's clothing for the legs and lower abdomen, a traditional form of tartan trousers from Scottish Highland dress

**triliteral** - consisting of three letters and especially of three consonants
...
**tucker** - a piece of lace or cloth in the neckline of a dress
...
**valance** - a length of decorative drapery attached to the canopy or frame of a bed in order to screen the structure or the space beneath it; a dust ruffle
...
**victualer** - a person who is licensed to sell alcoholic liquor
...
**whist** - hush (used to demand silence)
...
**withe** - a tough, flexible branch of an osier or other willow, used for tying, binding, or basketry
...
**yonks** - a very long time (as in "I haven't seen her for yonks")
